    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shijiId" name="shijiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安全管理编号" prop="anquanUuidNumber">
                       <el-input v-model="ruleForm.anquanUuidNumber"
                                 placeholder="安全管理编号" clearable  :readonly="ro.anquanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="安全管理编号" prop="anquanUuidNumber">
                           <el-input v-model="ruleForm.anquanUuidNumber"
                                     placeholder="安全管理编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.anquanPhoto" label="安全管理照片" prop="anquanPhoto">
                        <file-upload
                            tip="点击上传安全管理照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.anquanPhoto?$base.url+ruleForm.anquanPhoto:''"
                            @change="anquanPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.anquanPhoto" label="安全管理照片" prop="anquanPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.anquanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="危险程度" prop="anquanTypes">
                        <el-select v-model="ruleForm.anquanTypes" :disabled="ro.anquanTypes" placeholder="请选择危险程度">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="危险程度" prop="anquanValue">
                        <el-input v-model="ruleForm.anquanValue"
                            placeholder="危险程度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安全管理库存" prop="anquanKucunNumber">
                       <el-input v-model="ruleForm.anquanKucunNumber"
                                 placeholder="安全管理库存" clearable  :readonly="ro.anquanKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="安全管理库存" prop="anquanKucunNumber">
                           <el-input v-model="ruleForm.anquanKucunNumber"
                                     placeholder="安全管理库存" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.anquanContent"  label="操作规范" prop="anquanContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.anquanContent" label="操作规范" prop="anquanContent">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shijiId: false,
                    anquanUuidNumber: true,
                    anquanPhoto: false,
                    anquanTypes: false,
                    anquanKucunNumber: false,
                    anquanContent: false,
                    anquanDelete: false,
                    insertTime: false,
                },
                ...
                rules: {
                   ...
                   anquanUuidNumber: [
                              { required: true, message: '安全管理编号不能为空', trigger: 'blur' },
                          ],
                   anquanPhoto: [
                              { required: true, message: '安全管理照片不能为空', trigger: 'blur' },
                          ],
                   anquanTypes: [
                   ...
                   anquanKucunNumber: [
                              { required: true, message: '安全管理库存不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   anquanContent: [
                              { required: true, message: '操作规范不能为空', trigger: 'blur' },
                          ],
                   anquanDelete: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.anquanContent = _this.ruleForm.anquanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.anquanContent = this.ruleForm.anquanContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            anquanPhotoUploadChange(fileUrls){
                this.ruleForm.anquanPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
