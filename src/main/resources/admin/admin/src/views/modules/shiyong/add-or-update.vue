    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="使用记录名称" prop="shiyongName">
                       <el-input v-model="ruleForm.shiyongName"
                                 placeholder="使用记录名称" clearable  :readonly="ro.shiyongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="使用记录名称" prop="shiyongName">
                           <el-input v-model="ruleForm.shiyongName"
                                     placeholder="使用记录名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="使用记录编号" prop="shiyongUuidNumber">
                       <el-input v-model="ruleForm.shiyongUuidNumber"
                                 placeholder="使用记录编号" clearable  :readonly="ro.shiyongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="使用记录编号" prop="shiyongUuidNumber">
                           <el-input v-model="ruleForm.shiyongUuidNumber"
                                     placeholder="使用记录编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiyongPhoto" label="使用记录照片" prop="shiyongPhoto">
                        <file-upload
                            tip="点击上传使用记录照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shiyongPhoto?$base.url+ruleForm.shiyongPhoto:''"
                            @change="shiyongPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiyongPhoto" label="使用记录照片" prop="shiyongPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shiyongPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="使用记录类型" prop="shiyongTypes">
                        <el-select v-model="ruleForm.shiyongTypes" :disabled="ro.shiyongTypes" placeholder="请选择使用记录类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="使用记录类型" prop="shiyongValue">
                        <el-input v-model="ruleForm.shiyongValue"
                            placeholder="使用记录类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="使用数量" prop="shiyongShuliang">
                       <el-input v-model="ruleForm.shiyongShuliang"
                                 placeholder="使用数量" clearable  :readonly="ro.shiyongShuliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="使用数量" prop="shiyongShuliang">
                           <el-input v-model="ruleForm.shiyongShuliang"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.shiyongTime"  class="input" label="使用时间" prop="shiyongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.shiyongTime"
                                type="date"
                                placeholder="使用时间"
                                :disabled="ro.shiyongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiyongTime" label="使用时间" prop="shiyongTime">
                            <span v-html="ruleForm.shiyongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shiyongContent"  label="用途" prop="shiyongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shiyongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiyongContent" label="用途" prop="shiyongContent">
                            <span v-html="ruleForm.shiyongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiyongYesnoTypes" label="申请状态" prop="shiyongYesnoTypes">
                        <el-input v-model="ruleForm.shiyongYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiyongYesnoText" label="审核意见" prop="shiyongYesnoText">
                        <span v-html="ruleForm.shiyongYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiyongShenheTime" label="审核时间" prop="shiyongShenheTime">
                        <span v-html="ruleForm.shiyongShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    shiyongName: false,
                    shiyongUuidNumber: true,
                    shiyongPhoto: false,
                    shiyongTypes: false,
                    shiyongShuliang: false,
                    shiyongTime: false,
                    shiyongContent: false,
                    shiyongYesnoTypes: false,
                    shiyongYesnoText: false,
                    shiyongShenheTime: false,
                    shiyongDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    yonghuId: '',
                    shiyongName: '',
                    shiyongUuidNumber: new Date().getTime(),
                    shiyongPhoto: '',
                    shiyongTypes: '',
                    shiyongShuliang: '',
                    shiyongTime: '',
                ...
                rules: {
                   ...
                   shiyongName: [
                              { required: true, message: '使用记录名称不能为空', trigger: 'blur' },
                          ],
                   shiyongUuidNumber: [
                              { required: true, message: '使用记录编号不能为空', trigger: 'blur' },
                          ],
                   shiyongPhoto: [
                              { required: true, message: '使用记录照片不能为空', trigger: 'blur' },
                          ],
                   shiyongTypes: [
                              { required: true, message: '使用记录类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiyong_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiyongYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shiyongContent = _this.ruleForm.shiyongContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shiyongContent = this.ruleForm.shiyongContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`shiyong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiyongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            shiyongPhotoUploadChange(fileUrls){
                this.ruleForm.shiyongPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
