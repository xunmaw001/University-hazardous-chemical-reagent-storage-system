...
public class ShijiChuruInoutListView extends ShijiChuruInoutListEntity implements Serializable {
	...
	public ShijiChuruInoutListView() {

	}

	public ShijiChuruInoutListView(ShijiChuruInoutListEntity shijiChuruInoutListEntity) {
		try {
			BeanUtils.copyProperties(this, shijiChuruInoutListEntity);
	...
	public String toString() {
		return "ShijiChuruInoutListView{" +
