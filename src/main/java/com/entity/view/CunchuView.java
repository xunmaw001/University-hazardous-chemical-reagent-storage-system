...
*/
@TableName("cunchu")
public class CunchuView extends CunchuEntity implements Serializable {
	...
	* 存储类型的值
	*/
	@ColumnInfo(comment="存储类型的字典表值",type="varchar(200)")
	private String cunchuValue;
	...
	public CunchuView(CunchuEntity cunchuEntity) {
		try {
			BeanUtils.copyProperties(this, cunchuEntity);
	...
	* 获取： 存储类型的值
	*/
	public String getCunchuValue() {
		return cunchuValue;
	}
	/**
	* 设置： 存储类型的值
	*/
	public void setCunchuValue(String cunchuValue) {
		this.cunchuValue = cunchuValue;
	}
